...
namespace AplikasiInputDataMahasiswa
{
    public partial class Form1 : Form
    {
        ...
        private void InisialisasiListView()
        {
            ...
            lvwMahasiswa.Columns.Add("NIM", 90, HorizontalAlignment.Center);
            lvwMahasiswa.Columns.Add("Nama", 200, HorizontalAlignment.Left);
            lvwMahasiswa.Columns.Add("Kelas", 90, HorizontalAlignment.Center);
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            // set nilai masing-masing propertinya berdasarkan inputan yang ada di form
            mhs.Nim = txtNim.Text;
